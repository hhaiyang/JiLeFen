...
-(void)loadingSubviews
{
    ...
    self.backgroundImageView.frame = CGRectMake(0, 0, kScreenWidth, 44 + OriginY);
    ...
    self.navLabel.frame = CGRectMake(44, OriginY, kScreenWidth - 88, 44);
    self.navLabel.textAlignment = NSTextAlignmentCenter;
    self.navLabel.textColor = [UIColor whiteColor];
    self.navLabel.backgroundColor = [UIColor clearColor];
    self.navLabel.hidden = YES;
    
    self.leftBarButton = [HYButton buttonWithType:UIButtonTypeCustom];
    ...
    self.rightBarButton = [HYButton buttonWithType:UIButtonTypeCustom];
...
-(void)setLeftButtonItem:(HYBarButtonItem *)aLeftButtonItem
{
...
-(void)setRightButtonItem:(HYBarButtonItem *)rightButtonItem
{
        ...
        if (self.rightButtonItem.style == PPBarButtonItemStyleCustom)
        {
            if (self.rightButtonItem.title && self.rightButtonItem.image==nil && self.rightButtonItem.imageHighlight==nil)
            {
                ...
                CGSize labelsize = [self.rightButtonItem.title sizeWithFont:font
                                                          constrainedToSize:CGSizeMake(kScreenWidth, 44)
                                                              lineBreakMode:0];
                if (labelsize.width >44)
                {
                    CGRect newFrame = CGRectMake(kScreenWidth - labelsize.width, 20, labelsize.width, 44);
                    ...
                    //                    [self.rightBarButton setContentArea:FireflyCGRectMake(labelsize.width, 44, labelsize.width, 15)];
                }
                else
                {
                ...
                if ([self.rightButtonItem.title isEqualToString:NAVBAR_HOME])
                {
            ...
            else
            {
                ...
                if (self.rightButtonItem.image)
                {
                    ...
                    //                    [self.rightBarButton setContentArea:FireflyCGRectMake(44, 44, self.rightButtonItem.image.size.width, self.rightButtonItem.image.size.height)];
                }
                else
                {
                    [self.rightBarButton setBackgroundImage:nil forState:UIControlStateNormal];
                ...
                if (self.rightButtonItem.imageHighlight)
                {
                    ...
                    //                    [self.rightBarButton setContentArea:FireflyCGRectMake(44, 44,self.rightButtonItem.imageHighlight.size.width, self.rightButtonItem.imageHighlight.size.height)];
                }
                else
                {
                    [self.rightBarButton setBackgroundImage:nil forState:UIControlStateHighlighted];
